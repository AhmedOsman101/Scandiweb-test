...
class MysqlExceptionHandler {
  ...
  protected static function handleSyntaxError(array $error) {
    return static::generateErrorMessage(message: "SQL syntax error: " . implode(", ", $error));
  }
  ...
  protected static function handleInvalidColumnsCount(array $error) {
    return static::generateErrorMessage(message: "Column count doesn't match value count: " . implode(", ", $error));
  }
  ...
  protected static function handleNoTable(array $error) {
    return static::generateErrorMessage(message: "Table doesn't exist: " . implode(", ", $error));
  }
  ...
  protected static function handleInvalidCollation(array $error) {
    return static::generateErrorMessage(message: "Invalid collation: " . implode(", ", $error));
  }
